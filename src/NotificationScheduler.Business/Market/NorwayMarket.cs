...
{
    public class NorwayMarket : BaseMarket, IMarketFactory
    {
        public NorwayMarket(NotificationSchedulerContext context) : base(context)
        {

        }
        public async Task<ScheduleResponse> CreateNotification(Company company)
        {
            var dayList = new List<int>() { 1, 5, 10, 20 };
